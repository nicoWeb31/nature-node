      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)("success", "Log out successfully"); // location.reload(true);
          ...
          case 7:
            ...
            console.log("🚀 ~ file: login.js ~ line 38 ~ logout ~ error", _context2.t0);
...
var displayMap = function displayMap(locs) {
  mapboxgl.accessToken = "pk.eyJ1IjoicmlvdG5pY29sYXMiLCJhIjoiY2todzkxY3hjMXU2dDJ4a3pucXZmeW5iMiJ9.DHV1ypXc77BeGv3XVOCJjQ";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/mapbox/streets-v11",
    scrollZoom: false // center:[-188.113456,34.3456322],
    // zoom: 10,
    // interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "".concat(type.toUpperCase(), " Update with successfully"));
              window.location = "/me";
            }
...
var stripe = Stripe('pk_test_51HRKdeA61x8iFQGwNAQHs0z00n033hztv9zXnMHg3W5xCvWKRaLIkWpKtC7Pyz2Udj1txNtOxqQm09GasBhe1uFD00XgRMVLuv');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(tourId);
            _context.prev = 1;
            console.log('toto'); //1 get checkout sesison from api url

            _context.next = 5;
            return _axios.default.get("http://localhost:3003/api/v1/bookings/checkout-session/".concat(tourId));

          case 5:
            session = _context.sent;
            console.log("🚀 ~ file: stripe.js ~ line 7 ~ session", session); //2 create checkout plus charge cedit card 
...
var formSettings = document.querySelector(".form-user-data");
var formPasswordSettings = document.querySelector(".form-user-settings");
var bookBtn = document.getElementById("bookTour"); //delegation

if (mapBox) {
  var locs = JSON.parse(mapBox.dataset.locations);
...
if (formPasswordSettings) {
  formPasswordSettings.addEventListener("submit", /*#__PURE__*/function () {
